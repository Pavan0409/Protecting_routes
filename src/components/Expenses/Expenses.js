...
const Expenses = () => {
  ...
  const deleteListHandler = (id, itemMoney) => {
    ...
    fetch(
      ...
      if (res.ok) {
        setData(res.ok);
        console.log(res.ok, "delete part");
  ...
  return (
    <div>
      ...
      <form className={classes.form} onSubmit={expenseSubmitHandler}>
        <h2>Add Expenses</h2>

        <div className={classes.labput}>
        ...
        return (
          <ul key={item.id} className={classes.ul}>
            ...
            <div className={classes.btnn}>
              ...
              <button
                className={classes.edbtn}
                onClick={() => deleteListHandler(item.id, item.money)}
              >
                Delete
              </button>
            </div>
